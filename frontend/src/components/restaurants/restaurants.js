    ...
    return (
      <div className="restaurant-template">
        <div className="temp-left">
          <a className="restaurant-temp-name" href={this.props.restaurant.url} target="_blank" rel="noreferrer">Go to Yelp: {this.props.restaurant.name}</a>
        ...
        <div className="temp-right">
          <img src={this.props.restaurant.image_url} alt="restaurantImg" />
        </div>
